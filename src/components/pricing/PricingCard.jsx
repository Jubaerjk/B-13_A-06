            ...
            {name !== "Pro" ? (
                <div className="card bg-[#F9FAFC] shadow-sm">
                    <div className="card-body relative flex flex-col gap-6 p-6">
                        ...
                        <p className=""><span className="text-[#101727] text-4xl font-bold">${price}</span><span className="text-[#627382] text-xl">/{duration}</span></p>
                ...
                <div className="card bg-linear-to-l from-[#9514FA] to-[#5210C4] text-white shadow-sm">
                    <div className="card-body relative flex flex-col gap-6 p-6">
                        ...
                        <p className=""><span className="text-4xl font-bold">${price}</span><span className="text-xl">/{duration}</span></p>
