    ...
    return (
        <>
            <div className='bg-[#F5F7FA]'>
                <div className='space-y-6 container mx-auto text-center p-20  '>
                    ...
                    <div className="process flex gap-10">
                        <div className="process-item card w-96 bg-base-100 border border-[#E1E7FF] shadow-sm">
                            <div class="card-body">
                                <div className='flex justify-between'>
                                    <img src="" alt="" />
                                    <span class="badge badge-xs active_btn rounded-full text-white w-8 h-8 flex items-center justify-center">
                                        01
                                    </span>
                                </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    <h2 class="text-2xl text-[#101727] font-bold">Create Account</h2>
                        ...
                        <div className="process-item card w-96 bg-base-100 border border-[#E1E7FF] shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="flex flex-col gap-2">
                                    <h2 class="text-2xl text-[#101727] font-bold">Choose Products</h2>
                        ...
                        <div className="process-item card w-96 bg-base-100 border border-[#E1E7FF] shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="flex flex-col gap-2">
                                    <h2 class="text-2xl text-[#101727] font-bold">Start Creating</h2>
