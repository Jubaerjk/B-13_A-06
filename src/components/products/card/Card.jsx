...
const Card = ({ productCard, setCartNav, selectedProduct, setSelectedProduct }) => {
    ...
    return (
        <>
            <div className="card bg-base-100 border border-[#E1E7FF] shadow-sm h-full">
                <div className="card-body flex flex-col">
                    ...
                    <button
                        ...
                        className={`btn rounded-full btn-block mt-auto ${addedToCart ? "bg-[#E1E7FF] text-[#9514FA]" : "active_btn"
                            }`}
